...
//    static ArrayList<NewPhone> newPhones = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                e.printStackTrace();
                System.out.println("System wrong something error. Please try againt!!");
            }
        }
    }
    ...
    private static void mainMenu() {
        ...
        System.out.println("=           7. Tính tổng tiền sản phẩm                     =");
        System.out.println("=           8. Giam gia dien thoai cu                      =");
...
//                }
    ...
    public static void calculateTotalPrice() {
        ...
        System.out.println("Tong gia san pham la: " + total);
    }

    public static void discountOldPhone() {
        boolean idExit = true;
        do {
            System.out.print("Hay nhap ID san pham muon giam gia: ");
            String id = scanner.nextLine();
            for (Phone phone : phones) {
                if (phone.getId().equals(id)) {
                    idExit = true;
                    double discountPercent = PhoneValidation.inputDiscountPercentOldPhone("phan tram muon giam gia");

                    if (phone instanceof OldPhone) {
                        ((OldPhone) phone).discountOlePhone(discountPercent);
                        System.out.println("Da giam gia thanh cong!!");
                    }

                    if (phone instanceof NewPhone) {
                        System.out.println("Dien thoai moi khong nam trong chuong trinh giam gia");
                    }
                }
            }
            if (!idExit) {
